			...
			<div class="about_box">
				<ul class="place_list box_inner clear">
					<li><a href="#" onclick="$('.popup_base').css('height',$(document).height());$('.contact_pop').show();">
							<img class="img_topplace" src="/resources/home/img/no_image01.jpg"" alt="OOOO OOOOO" />
							<h3>Vietnam Caphe Sua Da</h3>
							<p class="txt">Vietnam Condensed Milk Coffee</p>
							<span class="view">VIEW</span></a>
					</li>
					<li><a href="#" onclick="$('.popup_base').css('height',$(document).height());$('.space_pop').show();">
							<img class="img_topplace" src="/resources/home/img/no_image02.jpg" alt="OOOO OOOOO" />
							<h3>Thailand Chayen</h3>
							<p class="txt">Thailand BlackMilkTea&GreenMilk Tea</p>
							<span class="view">VIEW</span></a>
					</li>
					<li><a href="#" onclick="$('.popup_base').css('height',$(document).height());$('.program_pop').show();">
							<img class="img_topplace" src="/resources/home/img/no_image03.jpg" alt="OOOO OOOOO" />
							<h3>Indonesia Avocado Smoothie</h3>
							<p class="txt">Indonesia Avocado Smoothie</p>
							<span class="view">VIEW</span></a>
					</li>
				</ul>
			</div>
